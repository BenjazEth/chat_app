...
const String defaultUserName = "Ben jamin";
...
class ChatWindow extends State<Chat> with TickerProviderStateMixin {
  final List<Msg> _messages = <Msg>[];//hold all of the text that a user input
  final TextEditingController _textController = new TextEditingController();//allow control what's happening with input box
      ...
      body: new Column(children: <Widget>[
        new Flexible(
            child: new ListView.builder(
              ...
              reverse: true,//start at the bottom and move to the top
